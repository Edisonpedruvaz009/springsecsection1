...
VALUES('Happy','happy@example.com','5334122365','{bcrypt}$2a$12$HcJ41PMazjZM7knSZF3aO.Tr/SirNv10ckUlOkmLVrs2eTH9YvA5O','admin',CURDATE());
...
`create_dt date` date DEFAULT NULL,
...
VALUES(1,1865764534,'savings','123 Main Strret, New York',CURDATE());
